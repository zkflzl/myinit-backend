...
CREATE TABLE `user_info`  (
  ...
  `icon` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '头像',
  `introduction` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '简介',
  `userRole` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限',
  `gender` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '性别',
